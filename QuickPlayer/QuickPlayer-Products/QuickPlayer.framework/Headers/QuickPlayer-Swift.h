...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="QuickPlayer",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif

typedef SWIFT_ENUM(NSInteger, PlayerStatus) {
  PlayerStatusBuffering = 0,
  PlayerStatusReadyToPlay = 1,
  PlayerStatusPaused = 2,
  PlayerStatusFailed = 3,
  PlayerStatusPlaying = 4,
  PlayerStatusStopped = 5,
  PlayerStatusFinished = 6,
  PlayerStatusUnknown = 7,
};
...
@interface QuickPlayerResourceManager (SWIFT_EXTENSION(QuickPlayer)) <NSURLSessionDataDelegate>
